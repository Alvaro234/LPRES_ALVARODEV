...
COMPONENT MChSolido(INTEGER nodos = 11)
	...
	DATA
			...
			REAL gamma =	1.21	
			REAL Viscosidad_camara =	8.19E-05	
			BOOLEAN Combustion_erosiva = TRUE	
			REAL gth =	35	
			REAL Temperatura_de_combustion =3056 UNITS	"K"
			REAL ce_estrella =	1515.53	UNITS "m/s"
			REAL Exponente =	0.36	
			REAL Factor_a =	4.092E-05	
			REAL R_gas = 318  UNITS "J/kgK"			
			-- DATOS MOTOR
			REAL Area_de_garganta	 = 4.34E-4	UNITS "m2"
			REAL L = 0.7080 UNITS "m" 				
	DECLS
